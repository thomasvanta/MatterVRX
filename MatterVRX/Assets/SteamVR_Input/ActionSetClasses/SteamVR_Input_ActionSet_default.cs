...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Vector2 TrackPadScroll
        {
            get
            {
                return SteamVR_Actions.default_TrackPadScroll;
            }
        }
        
        public virtual SteamVR_Action_Boolean ClickCenterPad
        {
            get
            {
                return SteamVR_Actions.default_ClickCenterPad;
            }
        }
